          ...
          return (
            <div
              ...
              className={`p-3 sm:p-3.5 rounded-xl border transition-all shadow-2xs ${
                isDebit
                  ? 'border-rose-200/70 bg-rose-50/20 hover:border-rose-300 dark:border-rose-900/40 dark:bg-rose-950/10'
                  : 'border-emerald-200/70 bg-emerald-50/20 hover:border-emerald-300 dark:border-emerald-900/40 dark:bg-emerald-950/10'
              }`}
            >
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2.5">
                ...
                <div className="min-w-0 flex-1 space-y-1.5">
                  <div className="flex items-center gap-1.5 flex-wrap">
                    ...
                    {tx.payment_method && (
                      <span className="text-[9.5px] font-bold text-slate-600 dark:text-slate-300 uppercase bg-white dark:bg-slate-800 px-1.5 py-0.5 rounded border border-slate-200 dark:border-slate-700 shadow-2xs">
                        {tx.payment_method}
                      </span>
                    )}
                    ...
                    {hasLinkedBill && (
                      <button
                        ...
                        className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-blue-50 hover:bg-blue-100 dark:bg-blue-950/60 dark:hover:bg-blue-900/80 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800 text-[10px] font-bold cursor-pointer transition shadow-2xs active:scale-95"
                    ...
                    {tx.notes ? (
                      tx.notes.includes('•') ? (
                        <div className="space-y-1">
                          ...
                          <div className="text-[11px] text-slate-600 dark:text-slate-300 bg-white/90 dark:bg-slate-800/80 p-2 rounded-lg border border-slate-200/80 dark:border-slate-700 flex items-start gap-1.5 font-sans">
                            <ShoppingBag className="w-3.5 h-3.5 text-amber-600 dark:text-amber-400 shrink-0 mt-0.5" />
                            <div>
                              <span className="font-bold text-slate-800 dark:text-slate-200">Items: </span>
                  ...
                  {/* Date Stamp */}
                  <div className="text-[10.5px] text-slate-400 dark:text-slate-500 flex items-center gap-1 font-medium">
                ...
                {/* Right Side: Amount, Balance After, & Actions */}
                <div className="flex sm:flex-col items-center sm:items-end justify-between sm:justify-start shrink-0 pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-100 dark:border-slate-800">
                  ...
                  <div className="flex items-center gap-1.5 mt-1 sm:mt-2">
                    <button
                      ...
                      className="p-1 sm:px-1.5 sm:py-0.5 rounded text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 transition cursor-pointer flex items-center gap-1 text-[10px] font-bold"
                    ...
                    <button
                      ...
                      className="p-1 sm:px-1.5 sm:py-0.5 rounded text-slate-400 hover:text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-950/40 transition cursor-pointer flex items-center gap-1 text-[10px] font-bold"
                      title="Delete entry"
                    >
